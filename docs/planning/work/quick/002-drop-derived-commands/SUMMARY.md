...
| File | Change |
|------|--------|
| `.cnogo/scripts/memory/bridge.py` | Removed commands.claim/report_done/context from plan_to_task_descriptions() output; derive them from task_id at render time in generate_implement_prompt() |
