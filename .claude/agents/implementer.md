...
0. **Locate worktree**: Your prompt starts with `WORKTREE: <path>`. Use this path as the prefix for ALL absolute file paths in Read/Edit/Write calls.
...
- You are working in the main checkout — the executor will copy your changes to the feature worktree after you complete
- Use the WORKTREE path from your prompt for ALL file operations. The system context may show a different path — use the one from your prompt.
